...
with st.form("my_form"):
  ...
  user_slider_housing_median_age = st.slider('Median_Age : ', min_value=0, max_value=0,value=50,step=10)
  user_slider_total_rooms = st.slider('total rooms : ', min_value=0, max_value=500,value=0,step=10)
  user_slider_total_bedrooms = st.slider('total_bedrooms : ', min_value=0, max_value=180,value=0,step=5)
  user_slider_population = st.slider('population : ', min_value=0, max_value=800000,value=0,step=1000)
  user_slider_households = st.slider('households : ', min_value=0, max_value=300,value=0,step=10)
  user_slider_median_income = st.slider('median_income : ', min_value=0, max_value=800000,value=0,step=1000)
